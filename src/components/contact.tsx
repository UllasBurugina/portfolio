...
// Updated LampContainer to support theme toggle
export const GreenLampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex h-[600px] flex-col items-center justify-center overflow-hidden bg-white dark:bg-black w-full z-0",
        className
      )}
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0">
        ...
        <div className="absolute inset-auto z-40 h-44 w-full -translate-y-[10rem] bg-white dark:bg-black"></div>
      </div>
...
// Contact Section Component with Theme Support
      ...
      <GreenLampContainer>
        ...
        >
          ...
          <div className="mt-12 flex flex-col items-center gap-6 md:flex-col md:gap-8">
            <h1 className="bg-gradient-to-br from-gray-800 to-gray-600 dark:from-gray-50 dark:to-gray-200 py-4 bg-clip-text text-center text-5xl font-light tracking-wider text-transparent md:text-7xl">
              Get in touch
            </h1>
            <motion.div
              ...
              className="flex items-center gap-2 bg-black dark:bg-white px-6 py-3 rounded-full border border-gray-200 dark:border-gray-800"
            >
              <Mail className="h-5 w-5 text-white dark:text-black" />
              <span className="text-white dark:text-black">buruginaullas@gmail.com</span>
            </motion.div>
            ...
            >
              ...
              <span className="text-white dark:text-black">+91 9148053860</span>
            </motion.div>
          </div>
        </motion.div>
      </GreenLampContainer>
